...
export default function DetailedAuthorizationRequest({ request }: Props) {
  const items = [
    {
      icon: <Building2 />,
  ...
  return (
    <div className="border-1 border-gray-200 rounded-lg">
      ...
      <div className="px-10 flex flex-col gap-3 mt-3 py-5">
        <button className="cursor-pointer w-full flex justify-center items-center gap-3 text-white bg-highlight-blue py-2 rounded-lg font-semibold">
          <CircleCheck />
          <span>Authorize Payment</span>
        </button>

        <button className="cursor-pointer border-2 border-highlight-red w-full flex justify-center items-center gap-3 text-highlight-red py-2 rounded-lg font-semibold">
          <CircleX />
